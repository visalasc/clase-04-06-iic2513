export const plants = [
  {
    id: 1,
    name: 'Monstera',
    image: 'https://images.unsplash.com/photo-1525498128493-380d1990a112?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    description: 'Planta tropical con hojas grandes.',
  },
  {
    id: 2,
    name: 'Ficus Lyrata',
    image: 'https://media.istockphoto.com/id/1321819499/photo/top-view-of-fiddle-leaf-fig.jpg?s=612x612&w=0&k=20&c=2Y3JX66SG0kdAYoRtXXFDGll_vshAOtqTV9lKuLqloA=',
    description: 'También conocida como fiddle leaf fig.',
  },
  {
    id: 3,
    name: 'Sansevieria',
